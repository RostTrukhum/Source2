...
window.addEventListener('DOMContentLoaded', function () {
  ...
  Object(_modules_sliders__WEBPACK_IMPORTED_MODULE_1__["default"])('.main-slider-item', 'verticale');
...
var calc = function calc(size, material, options, promocode, result, state) {
  ...
  var calcFunction = function calcFunction(price) {
...
var forms = function forms(state) {
  ...
  form.forEach(function (item) {
    item.addEventListener('submit', function (e) {
      ...
      console.log(api); // check up on class 
...
var showMoreStyles = function showMoreStyles(trigger, wrapper) {
  ...
  btn.addEventListener('click', function () {
    Object(_services_requests__WEBPACK_IMPORTED_MODULE_6__["getResource"])('http://localhost:3000/styles').then(function (res) {
      createCards(res);
    }).finally(this.remove());
  });
